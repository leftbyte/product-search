// Copyright 2023 Dan Phung.  All Rights Reserved.
//
...
//go:generate protoc --proto_path=$GOPATH/src --twirp_out=$GOPATH/src --go_out=$GOPATH/src github.com/leftbyte/product-seller/rpc/productseller/productseller.proto
